...
////            polygon.insertPoint(0, -1, new Point(5, 5));
//
...
//        }
    ...
    public static void testSquare() {
        ...
        Polygon convex_hull = (Polygon) (bounding.execute(densified, null));
        Polygon differenced = (Polygon) (difference.execute(densified, convex_hull, SpatialReferenceEx.create(4326).toSpatialReference(), null));
    ...
    public static void testPolygons() {
...

        {
            ...
            Polygon differenced = (Polygon) (difference.execute(shape, convex_hull, SpatialReferenceEx.create(4326).toSpatialReference(), null));
            assertTrue(differenced.isEmpty());
            assertTrue(bounding.isConvex(convex_hull, null));
        }
...

        {
            ...
            Polygon differenced = (Polygon) (difference.execute(polygon, convex_hull, SpatialReferenceEx.create(4326).toSpatialReference(), null));
            assertTrue(differenced.isEmpty());
            assertTrue(bounding.isConvex(convex_hull, null));
        }
    ...
    public static void testPolylines() {
...

        {
            ...
            Polyline convex_hull = (Polyline) (bounding.execute(densified, null));
            Polyline differenced = (Polyline) (difference.execute(densified, convex_hull, SpatialReferenceEx.create(4326).toSpatialReference(), null));
            assertTrue(differenced.isEmpty());
            assertTrue(bounding.isConvex(convex_hull, null));
        }

        {
            ...
            Polygon convex_hull = (Polygon) (bounding.execute(densified, null));
            boolean bcontains = contains.execute(convex_hull, densified, SpatialReferenceEx.create(4326).toSpatialReference(), null);
