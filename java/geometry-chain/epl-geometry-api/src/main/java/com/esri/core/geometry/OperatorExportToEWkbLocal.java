...
public class OperatorExportToEWkbLocal extends OperatorExportToEWkb {
	@Override
	public ByteBufferCursor execute(int exportFlags, GeometryCursor geometryCursor, SpatialReference spatialReference) {
		return new OperatorExportToEWkbCursor(exportFlags, geometryCursor, spatialReference);
	}
