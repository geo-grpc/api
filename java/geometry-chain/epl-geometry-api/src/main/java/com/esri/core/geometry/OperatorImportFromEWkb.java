...
public abstract class OperatorImportFromEWkb extends Operator {
	...
	/**
	 * @param importFlags     @param importFlags Use the {@link WkbImportFlags} interface.
	 * @param eWkbBuffers      The cursor over wkb buffers that hold the Geometries in extended wkb format.
	 * @return Returns a GeometryCursor.
	 */
	public abstract MapGeometryCursor execute(int importFlags, ByteBufferCursor eWkbBuffers, ProgressTracker progressTracker);
