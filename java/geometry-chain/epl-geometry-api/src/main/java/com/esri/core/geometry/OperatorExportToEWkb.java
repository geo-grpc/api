...
public abstract class OperatorExportToEWkb extends Operator {
	...
	/**
	 * Performs the ExportToEWKB operation on cursor of geometries
	 *
	 * @param exportFlags    This should probably be removed
	 * @param geometryCursor cursor of geometries to export
	 * @param spatialReference Spatial reference to assign in SRID (wkid) field of Extended WKB. Can be null.
	 * @return {@link ByteBufferCursor}
	 */
	public abstract ByteBufferCursor execute(int exportFlags, GeometryCursor geometryCursor, SpatialReference spatialReference);
