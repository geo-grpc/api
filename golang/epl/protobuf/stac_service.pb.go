...
func init() { proto.RegisterFile("epl/protobuf/stac_service.proto", fileDescriptor_fed8d97e526e3777) }

var fileDescriptor_fed8d97e526e3777 = []byte{
...
func (*UnimplementedStacServiceServer) Search(req *StacRequest, srv StacService_SearchServer) error {
	return status.Errorf(codes.Unimplemented, "method Search not implemented")
}
func (*UnimplementedStacServiceServer) Insert(srv StacService_InsertServer) error {
	return status.Errorf(codes.Unimplemented, "method Insert not implemented")
}
func (*UnimplementedStacServiceServer) Update(srv StacService_UpdateServer) error {
	return status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (*UnimplementedStacServiceServer) Count(ctx context.Context, req *StacRequest) (*StacDbResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Count not implemented")
}
func (*UnimplementedStacServiceServer) DeleteOne(ctx context.Context, req *StacItem) (*StacDbResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteOne not implemented")
}
func (*UnimplementedStacServiceServer) SearchOne(ctx context.Context, req *StacRequest) (*StacItem, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchOne not implemented")
}
func (*UnimplementedStacServiceServer) InsertOne(ctx context.Context, req *StacItem) (*StacDbResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InsertOne not implemented")
}
func (*UnimplementedStacServiceServer) UpdateOne(ctx context.Context, req *StacItem) (*StacDbResponse, error) {
