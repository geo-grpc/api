...
func (x GeometryEncodingType) Enum() *GeometryEncodingType {
	p := new(GeometryEncodingType)
	*p = x
	return p
}
...
func (x *GeometryEncodingType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(GeometryEncodingType_value, data, "GeometryEncodingType")
	if err != nil {
		return err
	}
	*x = GeometryEncodingType(value)
	return nil
}
func (GeometryEncodingType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{0}
}
...
func (x ServiceOperatorType) Enum() *ServiceOperatorType {
	p := new(ServiceOperatorType)
	*p = x
	return p
}
...
func (x *ServiceOperatorType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ServiceOperatorType_value, data, "ServiceOperatorType")
	if err != nil {
		return err
	}
	*x = ServiceOperatorType(value)
	return nil
}
func (ServiceOperatorType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{1}
}
...
func (x OffsetJoinType) Enum() *OffsetJoinType {
	p := new(OffsetJoinType)
	*p = x
	return p
}
...
func (x *OffsetJoinType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(OffsetJoinType_value, data, "OffsetJoinType")
	if err != nil {
		return err
	}
	*x = OffsetJoinType(value)
	return nil
}
func (OffsetJoinType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{2}
}
...
func (FileType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{3}
}

type GeometryData struct {
	GeometryId           *int64                `protobuf:"varint,1,opt,name=geometry_id,json=geometryId" json:"geometry_id,omitempty"`
	FeatureId            *string               `protobuf:"bytes,9,opt,name=feature_id,json=featureId" json:"feature_id,omitempty"`
	GeometryEncodingType *GeometryEncodingType `protobuf:"varint,2,opt,name=geometry_encoding_type,json=geometryEncodingType,enum=epl.protobuf.GeometryEncodingType" json:"geometry_encoding_type,omitempty"`
	// oneof block
	Wkt       *string `protobuf:"bytes,3,opt,name=wkt" json:"wkt,omitempty"`
	Geojson   *string `protobuf:"bytes,4,opt,name=geojson" json:"geojson,omitempty"`
	Wkb       []byte  `protobuf:"bytes,5,opt,name=wkb" json:"wkb,omitempty"`
	EsriShape []byte  `protobuf:"bytes,6,opt,name=esri_shape,json=esriShape" json:"esri_shape,omitempty"`
	// oneof block
	SpatialReference     *SpatialReferenceData `protobuf:"bytes,7,opt,name=spatial_reference,json=spatialReference" json:"spatial_reference,omitempty"`
...
func (m *GeometryData) GetGeometryEncodingType() GeometryEncodingType {
	if m != nil && m.GeometryEncodingType != nil {
...
type GeometryBagData struct {
	// oneof block start
	GeometryIds []int64  `protobuf:"varint,1,rep,name=geometry_ids,json=geometryIds" json:"geometry_ids,omitempty"`
	FeatureIds  []string `protobuf:"bytes,9,rep,name=feature_ids,json=featureIds" json:"feature_ids,omitempty"`
	// type can be 'wkt', 'wkb', 'geojson', or 'esri'
	GeometryEncodingType *GeometryEncodingType `protobuf:"varint,2,opt,name=geometry_encoding_type,json=geometryEncodingType,enum=epl.protobuf.GeometryEncodingType" json:"geometry_encoding_type,omitempty"`
	Wkt                  []string              `protobuf:"bytes,3,rep,name=wkt" json:"wkt,omitempty"`
	Geojson              []string              `protobuf:"bytes,4,rep,name=geojson" json:"geojson,omitempty"`
	Wkb                  [][]byte              `protobuf:"bytes,5,rep,name=wkb" json:"wkb,omitempty"`
	EsriShape            [][]byte              `protobuf:"bytes,6,rep,name=esri_shape,json=esriShape" json:"esri_shape,omitempty"`
	SpatialReference     *SpatialReferenceData `protobuf:"bytes,7,opt,name=spatial_reference,json=spatialReference" json:"spatial_reference,omitempty"`
	EsriJson             []string              `protobuf:"bytes,8,rep,name=esri_json,json=esriJson" json:"esri_json,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
type OperatorResult struct {
	...
	RelateMap            map[int64]bool   `protobuf:"bytes,4,rep,name=relate_map,json=relateMap" json:"relate_map,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *OperatorResult) GetSpatialRelationship() bool {
	if m != nil && m.SpatialRelationship != nil {
...
type FileChunk struct {
	NestedRequest          *OperatorRequest      `protobuf:"bytes,1,opt,name=nested_request,json=nestedRequest" json:"nested_request,omitempty"`
	ResultsEncodingType    *GeometryEncodingType `protobuf:"varint,2,opt,name=results_encoding_type,json=resultsEncodingType,enum=epl.protobuf.GeometryEncodingType" json:"results_encoding_type,omitempty"`
	InputSpatialReference  *SpatialReferenceData `protobuf:"bytes,3,opt,name=input_spatial_reference,json=inputSpatialReference" json:"input_spatial_reference,omitempty"`
	ResultSpatialReference *SpatialReferenceData `protobuf:"bytes,5,opt,name=result_spatial_reference,json=resultSpatialReference" json:"result_spatial_reference,omitempty"`
	...
	IsLastChunk            *bool                 `protobuf:"varint,10,opt,name=is_last_chunk,json=isLastChunk" json:"is_last_chunk,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}              `json:"-"`
	XXX_unrecognized       []byte                `json:"-"`
	XXX_sizecache          int32                 `json:"-"`
}
...
func (*FileChunk) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{4}
}
...
func (m *FileChunk) GetResultsEncodingType() GeometryEncodingType {
	if m != nil && m.ResultsEncodingType != nil {
...
type BufferParams struct {
	Distances               []float64 `protobuf:"fixed64,1,rep,name=distances" json:"distances,omitempty"`
	MaxDeviations           []float64 `protobuf:"fixed64,2,rep,name=max_deviations,json=maxDeviations" json:"max_deviations,omitempty"`
...
func (*BufferParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{5}
}
...
func (m *BufferParams) GetMaxVerticesInFullCircle() int32 {
	if m != nil && m.MaxVerticesInFullCircle != nil {
...
func (*GeodeticBufferParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{6}
}
...
func (*ConvexParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{7}
}
...
func (*RelateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{8}
}
...
type RandomPointsParams struct {
	PointsPerSquareKm    []float64 `protobuf:"fixed64,1,rep,name=points_per_square_km,json=pointsPerSquareKm" json:"points_per_square_km,omitempty"`
...
func (*RandomPointsParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{9}
}
...
func (*GeneralizeParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{10}
}
...
func (m *GeneralizeParams) GetRemoveDegenerates() bool {
	if m != nil && m.RemoveDegenerates != nil {
...
type GeneralizeByAreaParams struct {
	PercentReduction     *float64 `protobuf:"fixed64,1,opt,name=percent_reduction,json=percentReduction" json:"percent_reduction,omitempty"`
	RemoveDegenerates    *bool    `protobuf:"varint,2,opt,name=remove_degenerates,json=removeDegenerates" json:"remove_degenerates,omitempty"`
	MaxPointCount        *int32   `protobuf:"varint,3,opt,name=max_point_count,json=maxPointCount" json:"max_point_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*GeneralizeByAreaParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{11}
}
...
func (m *GeneralizeByAreaParams) GetPercentReduction() float64 {
	if m != nil && m.PercentReduction != nil {
...
func (*IntersectionParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{12}
}
...
type OffsetParams struct {
	...
	JoinType             *OffsetJoinType `protobuf:"varint,2,opt,name=join_type,json=joinType,enum=epl.protobuf.OffsetJoinType" json:"join_type,omitempty"`
...
func (*OffsetParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{13}
}
...
func (*CutParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{14}
}
...
func (*ClipParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{15}
}
...
func (*DensifyParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{16}
}
...
func (*SimplifyParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{17}
}
...
type OperatorRequest struct {
	//    oneof primary_geoms {
	GeometryBag         *GeometryBagData `protobuf:"bytes,1,opt,name=geometry_bag,json=geometryBag" json:"geometry_bag,omitempty"`
	GeometryRequest     *OperatorRequest `protobuf:"bytes,2,opt,name=geometry_request,json=geometryRequest" json:"geometry_request,omitempty"`
	...
	LeftGeometryRequest *OperatorRequest `protobuf:"bytes,4,opt,name=left_geometry_request,json=leftGeometryRequest" json:"left_geometry_request,omitempty"`
	...
	RightGeometryRequest      *OperatorRequest      `protobuf:"bytes,6,opt,name=right_geometry_request,json=rightGeometryRequest" json:"right_geometry_request,omitempty"`
	OperatorType              *ServiceOperatorType  `protobuf:"varint,7,opt,name=operator_type,json=operatorType,enum=epl.protobuf.ServiceOperatorType" json:"operator_type,omitempty"`
	ResultsEncodingType       *GeometryEncodingType `protobuf:"varint,8,opt,name=results_encoding_type,json=resultsEncodingType,enum=epl.protobuf.GeometryEncodingType" json:"results_encoding_type,omitempty"`
	...
	GeneralizeByAreaParams *GeneralizeByAreaParams `protobuf:"bytes,22,opt,name=generalize_by_area_params,json=generalizeByAreaParams" json:"generalize_by_area_params,omitempty"`
	Geometry               *GeometryData           `protobuf:"bytes,23,opt,name=geometry" json:"geometry,omitempty"`
	LeftGeometry           *GeometryData           `protobuf:"bytes,24,opt,name=left_geometry,json=leftGeometry" json:"left_geometry,omitempty"`
	RightGeometry          *GeometryData           `protobuf:"bytes,25,opt,name=right_geometry,json=rightGeometry" json:"right_geometry,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                `json:"-"`
	XXX_unrecognized       []byte                  `json:"-"`
	XXX_sizecache          int32                   `json:"-"`
}
...
func (*OperatorRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{18}
}
...
func (*EnvelopeData) Descriptor() ([]byte, []int) {
	return fileDescriptor_geometry_ac85da0d44617808, []int{19}
}
...
func init() {
	proto.RegisterFile("epl/protobuf/geometry.proto", fileDescriptor_geometry_ac85da0d44617808)
}

var fileDescriptor_geometry_ac85da0d44617808 = []byte{
	...
	,
}
