...
func (m *GeometryField) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GeometryField.Merge(m, src)
}
...
func (m *BandDetails) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BandDetails.Merge(m, src)
}
