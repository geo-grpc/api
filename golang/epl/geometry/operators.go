...
func GeomPbToGeom(geometryData *eplpbv1.GeometryData) (error, geom.T) {
	...
	if geometryData.GetEwkb() != nil {
		...
		//	var err2 error
		//	err2, geometry = gs.SingleInputChain(nil, &emptyRequest, nil).Execute()
		//	err = *err2
	} else {
...
func relation(left geom.T, right geom.T, operatorType eplpbv1.OperatorType) (error, bool) {
...
func Buffer(t geom.T, distance float64) (error, geom.T) {
...
func ConvexHull(t geom.T) (error, geom.T) {
...
//
func DensifyByLength(t geom.T, maxLength float64) (error, geom.T) {
...
func Generalize(t geom.T, maxDeviation float64, removeDegenerates bool) (error, geom.T) {
...
func GeodesicBuffer(t geom.T, distanceMeters float64, maxDeviationMeters float64) (error, geom.T) {
...
func GeodeticDensifyByLength(t geom.T, maxDistanceMeters float64) (error, geom.T) {
	return InitChain(t).GeodeticDensifyByLength(maxDistanceMeters).Execute()
}

// Performs the Project operation
func Project(t geom.T, resultEpsg int32) (error, geom.T) {
...
func Simplify(t geom.T, force bool) (error, geom.T) {
...
func Difference(left geom.T, right geom.T) (error, geom.T) {
	leftChain := InitChain(left)
