 ...
 */
public abstract class OperatorBufferEx extends OperatorEx {
    @Override
    public Type getType() {
        return Type.Buffer;
    }
    ...
    public static OperatorBufferEx local() {
        return (OperatorBufferEx) OperatorFactoryLocalEx.getInstance().getOperator(Type.Buffer);
    }
}
