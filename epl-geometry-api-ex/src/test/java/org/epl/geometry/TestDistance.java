...
public class TestDistance extends TestCase {
    ...
    public static void testDistanceBetweenVariousGeometries() {
        ...
        // SpatialReferenceEx spatialRef =
        // SpatialReferenceEx.create(3857);//PCS_WGS_1984_WEB_MERCATOR_AUXSPHERE

        double distance;

        distance = GeometryEngineEx.distance(polygon, polyline, SpatialReferenceEx.create(4326));
        assertTrue(Math.abs(distance - 5.0) < 0.00001);

        distance = GeometryEngineEx.distance(polygon, multipoint, SpatialReferenceEx.create(4326));
        assertTrue(Math.abs(distance - 5.0) < 0.00001);

        distance = GeometryEngineEx.distance(polygon, point, SpatialReferenceEx.create(4326));
        assertTrue(Math.abs(distance - 5.0) < 0.00001);
    }
    ...
    public static void testDistanceBetweenTriangles() {
        ...
        distance = GeometryEngineEx.distance(poly, poly2, SpatialReferenceEx.create(4326));
    ...
    public static void testDistanceBetweenPointAndEnvelope() {
        ...
        double dist = GeometryEngineEx.distance(env, pt, SpatialReferenceEx.create(4326));  // expect just under 10.
