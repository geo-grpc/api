...
public class TestCut extends TestCase {
    ...
    public static void testConsiderTouch1(SpatialReferenceEx spatialReference) {
        ...
        GeometryCursor cursor = opCut.execute(true, simpleGeometryCursor, cutter1,
                spatialReference.toSpatialReference(), null);
        Polyline cut;
        int pathCount;
        int segmentCount;
        double length;
    ...
    public static void testConsiderTouch2(SpatialReferenceEx spatialReference) {
        OperatorFactoryLocal engine = OperatorFactoryLocal.getInstance();
        OperatorCut opCut = (OperatorCut) engine.getOperator(Operator.Type.Cut);
    ...
    public static void testPolygon5(SpatialReferenceEx spatialReference) {
        OperatorFactoryLocal engine = OperatorFactoryLocal.getInstance();
        OperatorCut opCut = (OperatorCut) engine.getOperator(Operator.Type.Cut);
    ...
    public static void testPolygon7(SpatialReferenceEx spatialReference) {
        OperatorFactoryLocal engine = OperatorFactoryLocal.getInstance();
        OperatorCut opCut = (OperatorCut) engine.getOperator(Operator.Type.Cut);
    ...
    public static void testPolygon8(SpatialReferenceEx spatialReference) {
        OperatorFactoryLocal engine = OperatorFactoryLocal.getInstance();
        OperatorCut opCut = (OperatorCut) engine.getOperator(Operator.Type.Cut);
    ...
    public static void testPolygon9(SpatialReferenceEx spatialReference) {
        OperatorFactoryLocal engine = OperatorFactoryLocal.getInstance();
        OperatorCut opCut = (OperatorCut) engine.getOperator(Operator.Type.Cut);
    ...
    public static void testEngine(SpatialReferenceEx spatialReference) {
        Polygon polygon8 = makePolygon8();
        Polyline cutter8 = makePolygonCutter8();

        Geometry[] cuts = GeometryEngineEx.cut(polygon8, cutter8,
                spatialReference);
        Polygon cut;
        int pathCount;
        int pointCount;
