...
class OperatorProjectLocal extends OperatorProject {
    ...
    public int transform(ProjectionTransformation transform,
        ...
        return Projector.transform(transform, pointsIn, count, pointsOut);
    }
    ...
    public double[] transform(ProjectionTransformation transform,
        ...
        return Projector.transform(transform, coordsSrc, bHasZ);
    }

    @Override
    public Geometry foldInto360RangeGeodetic(Geometry _geom, SpatialReferenceEx pannableSR, int curveType) {
        return _geom;
    }
