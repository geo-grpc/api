...
public abstract class OperatorGeodesicBuffer extends OperatorEx {

    @Override
    public OperatorEx.Type getType() {
        return OperatorEx.Type.GeodesicBuffer;
    }
    ...
    public static OperatorGeodesicBuffer local() {
        return (OperatorGeodesicBuffer) OperatorFactoryLocalEx.getInstance().getOperator(Type.GeodesicBuffer);
    }
}
