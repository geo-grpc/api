...
inline bool FilterRelationship_Parse(
    const std::string& name, FilterRelationship* value) {
...
class FloatFilter :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_epl_2fprotobuf_2fv1_2fquery_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline PROTOBUF_NAMESPACE_ID::Timestamp* TimestampFilter::_internal_mutable_value() {
  if (!_internal_has_value()) {
    clear_data();
    set_has_value();
    data_.value_ = CreateMaybeMessage< PROTOBUF_NAMESPACE_ID::Timestamp >(
        GetArenaNoVirtual());
  }
  return data_.value_;
}
...
inline PROTOBUF_NAMESPACE_ID::Timestamp* TimestampFilter::_internal_mutable_start() {
  if (!_internal_has_start()) {
    clear_data();
    set_has_start();
    data_.start_ = CreateMaybeMessage< PROTOBUF_NAMESPACE_ID::Timestamp >(
        GetArenaNoVirtual());
  }
  return data_.start_;
}
...
inline void StringFilter::set_value(const char* value, size_t size) {
