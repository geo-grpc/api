...
serviceGeomPolyline = geometry_operators_pb2.ServiceGeometry(geometry_string=polyline.wkt,
                                                             geometry_encoding_type='wkt',
                                                             spatial_reference=serviceSpatialReference)
opRequestProject = geometry_operators_pb2.OperatorRequest(left_geometry=serviceGeomPolyline,
