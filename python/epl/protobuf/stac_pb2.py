...
_EO_BAND = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NEAR_INFRARED', index=6, number=32,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RGBIR', index=7, number=60,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SWIR_16', index=8, number=64,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SWIR_22', index=9, number=128,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PANCHROMATIC', index=10, number=256,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CIRRUS', index=11, number=512,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LWIR_11', index=12, number=1024,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LWIR_12', index=13, number=2048,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
